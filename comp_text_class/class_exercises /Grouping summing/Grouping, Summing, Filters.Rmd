...
#added the population totals for the asian, hispanic, and pacific islander total
...
# or could use the function count()
...
```{r}
print(paste0("The percentage of the city's census tracts below the average of $", answer, is: )
