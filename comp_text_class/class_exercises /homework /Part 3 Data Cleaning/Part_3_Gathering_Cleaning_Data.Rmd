...
#if it says ABA we are going to name it as Abated, if it says ADM it is going to change it to Admonished, case_when is a good way of caterogrizing discreet variables 
```
